...
// () 다음에 => 연산자가 나타난다.
const func1 = () => {
  console.log("나는 화살표(Arrow)함수");
};
func1();

// 한 개의 매개변수를 갖는 func2 함수 선언
const func2 = (num) => {
  console.log(num);
};

// 두 개의 매개변수를 받는 func3 함수 선언
// 두 개의 매개변수 값을 덧셈하여 return
const func3 = (num1, num2) => {
  return num1 + num2;
};

// 두 개의 매개변수를 받아서 덧셈하여 return하는 func4 함수
// 함수 본체에 다른 코드가 없이 오로지 return 명령문만 있을 경우 {}와 return 키워드를 생략할 수 있다.
